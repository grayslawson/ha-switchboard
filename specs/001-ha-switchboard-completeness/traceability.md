...
| FR-006 | Partial | Plural bounded groups for explicit light/switch/fan on/off exist. The generated requirement's full area/label/group promise and broader operation coverage are not implemented. |
