...
**Reviewed revision:** `e8538be3548ddaf7a84d05d06ff279fa787ba1fc` on
...
The latest full repository test run on 2026-09-20 was `445 passed, 4 skipped`. The
...
| FR-006 | Partial | Plural bounded groups for explicit light/switch/fan on/off exist and can be narrowed by one unambiguous known area, floor, or label. Home Assistant group membership, mixed-domain groups, and broader operation coverage are not implemented. |
...
| FR-016 | Partial | Options have schema, defaults, translations, and documentation. `supervisor_read_only` remains an accepted inert option, which the generated plan says should be removed or migrated. |
