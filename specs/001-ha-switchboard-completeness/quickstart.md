...
`1ccb6ce2ba5e162249f4f15847280763aee4fb9e` was `459 passed, 4 skipped`.
...
- Worktree: `codex/fix-apparmor-runtime`, current `HEAD`
  `1ccb6ce2ba5e162249f4f15847280763aee4fb9e`. This is the source revision
...
- Current local source checks: `python3 -m compileall -q
  ...
  `python3 -m pytest -q tests` passed (`459 passed, 4 skipped`); and
